...
- **`Card.tsx`** · 416 lines — Displays one board task as a clean, rounded card inside a column.
- **`CardStack.tsx`** · 313 lines — Renders a group of 2+ cards that share the same `[bracket]` or `#hashtag` title tag as a visually stacked card.
