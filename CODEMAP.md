...
- **`kandown.js`** · 4537 lines · ⚠️ **GENERATED** by tsup — edit `src/cli/cli.ts` instead
- **`tui.js`** · 60485 lines · ⚠️ **GENERATED** by tsup — edit `src/cli/tui.tsx` instead
...
179 of 179 eligible files carry an `@description` header.
