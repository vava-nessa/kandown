...
- [x] **[t-002]** add some error handlers (3/3) → [détails](tasks/t-002.md) `#p1` `@opencode` `ai`
- [x] **[t-006]** Configure agent system for kandown (3/3) → [détails](tasks/t-006.md) `#setup` `#p1` `ai`
