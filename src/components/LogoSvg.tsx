/**
 * @file Brand Logo Component
 * @description Renders the official Kandown vector logo from logo.svg.
 *
 * @functions
 *  → LogoSvg — renders scalable multi-color brand icon
 *
 * @exports LogoSvg
 */
...
export function LogoSvg({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M148,21.594L148,128.406C148,139.22 139.22,148 128.406,148L21.594,148C10.78,148 2,139.22 2,128.406L2,21.594C2,10.78 10.78,2 21.594,2C139.22,2 148,10.78 148,21.594Z"
        style={{ fill: 'url(#_KandownLinear1)' }}
      />
      ...
      <defs>
        <linearGradient id="_KandownLinear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(62,131,-131,62,9,8)">
          <stop offset="0" style={{ stopColor: 'rgb(12,29,23)', stopOpacity: 1 }} />
          <stop offset="1" style={{ stopColor: 'rgb(24,41,35)', stopOpacity: 1 }} />
        </linearGradient>
      </defs>
    </svg>
  );
