/**
 * @file Settings — single setting row
 * @description Renders one SettingDef as either a dense toggle row or one of
 * the secondary controls: select dropdown, number stepper, text input,
 * language picker, theme mode switcher, or notification permission button.
 * The theme gallery that used to sit here was removed with the redesign
 * (t333): the app ships a single base theme and the picker had no job left.
 *
