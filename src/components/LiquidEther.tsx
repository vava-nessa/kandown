/**
 * @file Liquid Ether background component
 * @description Animated fluid simulation background using WebGL/GLSL shaders.
 * Renders behind the board content when selected as the app background.
 *
 * @see https://github.com/lusexistence/react-bits#liquiddether
