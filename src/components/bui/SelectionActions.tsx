/**
 * @file Selection actions from BeautifulUI
 * @description Faithful port of the BeautifulUI SelectionActions
 * (beautifului.dev, MIT): a contextual AI bar attached beneath selected
 * text. The global theme owns its surface; this component only composes
 * existing surface, ink, accent, radius and motion tokens. The
 * iconoir-react icons of the original are swapped for the closest
 * @tabler/icons-react equivalents; Shimmer and StreamText live in
 * ./atoms.
 *
 * @exports SelectionActions
 * @exports SelectionText
 * @exports SelectionAction
 * @exports SelectionActionSet
 * @exports SelectionActionsLabels
 * @exports SelectionActionsProps
 * @see src/components/bui/atoms/Shimmer.tsx
 * @see src/components/bui/atoms/StreamText.tsx
 * @see src/components/bui/primitives/Button.tsx
 */
...
const icons = {
  explain: <IconMessageCircleQuestion {...iconProps} />,
  improve: <IconSparkles {...iconProps} />,
  shorten: <IconScissors {...iconProps} />,
  tone: <IconMoodSmile {...iconProps} />,
  grammar: <IconTextGrammar {...iconProps} />,
  send: (
    <IconArrowUp
      width="16"
      height="16"
  ...
  chevron: <IconChevronRight {...iconProps} />,
  check: <IconCheck {...iconProps} />,
  close: <IconX {...iconProps} />,
  retry: <IconRefresh {...iconProps} />,
};
