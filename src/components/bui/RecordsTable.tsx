/**
 * @file Records table from BeautifulUI
 * @description Faithful port of the BeautifulUI RecordsTable
 * (beautifului.dev, MIT): an AI spreadsheet grid whose columns are
 * properties. Click a header to open its configuration popover (type,
 * tool, grounding, inputs, prompt, run), add a new AI property from the
 * + header, and watch cells resolve row-by-row while it calculates.
 * The .records-* classes it styles itself with are appended to
