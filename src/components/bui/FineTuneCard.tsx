/**
 * @file Fine-tune card from BeautifulUI
 * @description Faithful port of the BeautifulUI FineTuneCard
 * (beautifului.dev, MIT): a compact interactive inspector whose number
 * fields scrub (drag the label, use the arrow keys, or type), with a
 * segment switch and a GlideMenu type select. Written against the scoped
 * `.bui` tokens from styles/beautifului.css.
 *
 * @exports FineTuneCard
 * @exports FineTuneField
 * @exports FineTuneCardLabels
 * @exports FineTuneState
 * @exports FineTuneCardProps
 ...
 * drag to adjust, use arrows (shift for x10), or type directly.
 * BeautifulUI (beautifului.dev, MIT) */
