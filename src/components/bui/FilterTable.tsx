/**
 * @file Filter table from BeautifulUI
 * @description Faithful port of the BeautifulUI FilterTable
 * (beautifului.dev, MIT): the status chips directly filter the task table
 * and rows collapse through an animated grid-rows transition. Status pills
 * are styled by the .filter-status-* classes appended to
 * styles/beautifului.css.
 *
 * @exports FilterTable
 * @exports TableRow
 * @exports FilterTableLabels
