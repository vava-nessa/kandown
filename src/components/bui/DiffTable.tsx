/**
 * @file Diff table from BeautifulUI
 * @description Faithful port of the BeautifulUI DiffTable
 * (beautifului.dev, MIT): the proposed edit plays once and rests on the
 * completed diff; each changed row is the control, so a click includes or
 * excludes that specific addition or removal before applying. Written
 * against the scoped `.bui` tokens from styles/beautifului.css.
 *
 * @exports DiffTable
 * @exports DiffRow
...
/* DIFF TABLE: BeautifulUI (beautifului.dev, MIT).
 * The proposed edit plays once and rests on the completed diff.
 * Each changed row is the control: click it to include or exclude
 * that specific addition/removal before applying. */
              ...
              <>
                ...
                <span className="flex items-center gap-1.5">
                  <button
                    ...
                    className="rounded-control bg-accent px-2.5 py-1 text-[12px] font-medium text-white shadow-btn transition-all duration-150 hover:brightness-105 disabled:opacity-40"
                  >
