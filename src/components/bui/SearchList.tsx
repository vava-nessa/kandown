/**
 * @file Search list of the BeautifulUI chat kit
 * @description Faithful port of the BeautifulUI SearchList component
 * (beautifului.dev, MIT): a command search with live filtering. The input
 * row filters the item list as you type, a clear button fades in when a
 * query is set, and an empty state appears once no rows match. Result rows
 * opt into the GlideMenu highlight with data-menu-row, so the hover pill
 * glides between them.
 *
 * @exports SearchList (default) : the search card
 * @exports SearchItem : one searchable row (a plain string)
 * @exports SearchListLabels : placeholder, aria and empty-state copy
