/**
 * @file Tool Chips of the BeautifulUI design system
 * @description An agent run as compact tool rows with inline chips, then
 * file-diff chips summarizing the edits; hovering a file chip opens its diff
