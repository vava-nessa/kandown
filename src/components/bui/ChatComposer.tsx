/**
 * @file Chat composer of the BeautifulUI chat kit
 * @description Faithful port of the BeautifulUI ChatComposer component
 * (beautifului.dev, MIT): an interactive chat panel with suggestion tabs,
 * header actions, a submitted-prompt bubble and staged assistant replies
 * that blur while resolving. Sending from the composer restarts the
 * send/reply choreography, driven entirely by local phase state.
 *
 * @exports ChatComposer (default) : the tabbed chat panel
 * @exports ChatMessage : one assistant reply (label, sub, time, body)
 * @exports ChatComposerLabels : initial prompt and placeholder copy
