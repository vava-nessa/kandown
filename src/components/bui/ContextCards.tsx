/**
 * @file Context cards from BeautifulUI
 * @description Faithful port of the BeautifulUI ContextCards
 * (beautifului.dev, MIT): retrieved chunks enter once with a staggered
