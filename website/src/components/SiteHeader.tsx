    ...
    >
      <div className="mx-auto flex h-14 max-w-6xl items-center gap-7 px-5 sm:px-8">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {/* 📖 Pill next to the GitHub icon — same target as the icon
              (the whole repo link), but the star count gives the link a
              concrete social-proof value the icon alone does not. */}
