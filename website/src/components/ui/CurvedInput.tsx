/**
 * @file src/components/ui/CurvedInput.tsx
 * @description Curved input bar component from React Bits, rendering a smooth SVG curve input field with custom typography and interactive submission.
 *
 * 📖 Maps flat input coordinates onto a circular arc using SVG path geometry.
 * 📖 Supports light and dark presets or custom color overrides, responsive resize observation, and interactive caret tracking along the curve.
 *
 * @exports CurvedInput
 */
...
// centerline, positive down) onto a circular arc with the given sagitta (`bend`, in px).
...
// 📖 A rectangle bent along the arc: circular top/bottom edges, radial end caps and quadratic rounded corners.
...
export function CurvedInput({
  ...
  // 📖 Measure rendered text to keep caret on curve and scroll long values along arc.
  useLayoutEffect(() => {
  ...
  // 📖 Click on curve focuses hidden input and drops caret on character closest to click.
