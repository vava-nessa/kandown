...
export const Route = createFileRoute('/docs/$')({
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ...
      : [],
    // 📖 Points a machine reader at the Markdown twin of this page without
    // making it guess the convention. Generated by scripts/build-llms.mjs from
    // the same MDX this page renders, so the two cannot disagree.
    links: loaderData
      ? [
          {
            rel: 'alternate',
            type: 'text/markdown',
            href: `/docs/${loaderData.slug}.md`,
    ...
    <div className="xl:grid xl:grid-cols-[minmax(0,1fr)_13rem] xl:gap-10">
      <article className="min-w-0 py-10 lg:py-16">
        ...
        <header className="mb-9 border-b border-border pb-8">
          {/* 📖 The section label and the Markdown controls share a row: both
              are chrome about the page rather than part of it, and putting the
              copy button on the title line would fight the heading. */}
          <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
            <p className="label">{frontmatter.section ?? ''}</p>
