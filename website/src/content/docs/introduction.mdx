...
<Callout type="tip">
Prefer to poke at it first? The [interactive demo](/demo) runs the real application in your
browser, on a project held in memory. Nothing is installed, nothing is saved, and reloading the
page puts everything back.
</Callout>
